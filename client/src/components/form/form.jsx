        ...
        <form onSubmit={submitHandler} className={style.form}>
            ...
            <div className={style.items}>
                <div>
                    ...
                    <input type="text" name="name" value={Activity.name} onChange={handleChange} placeholder="Activity name..." className={style.name}></input>
                    <span className={style.errors}>{errors.name}</span>
                </div>

                <div style={{marginBottom:`15px`,marginTop:`15px`}}>
                    <label htmlFor="duration">Duration: </label>
                    <input type="text" name="duration" value={Activity.duration} onChange={handleChange} placeholder='"X" hours...' className={style.duration}></input> 
